...
test('Cockpit owns a focused shared Display portal and compact Radio controls', () => {
  ...
  assert.match(css, /\.cockpit-utility-control\.is-expanded \.cockpit-utility-divider\s*\{[\s\S]*?linear-gradient\(90deg, rgb\(0 212 255 \/ 28%\), rgba\((?:0, 212, 255|var\(--accent-rgb\)), 0\.18\) 58%, transparent\)[\s\S]*?box-shadow:\s*0 0 7px rgba\((?:0, 212, 255|var\(--accent-rgb\)), \.22\);/);

...
export const SCENES = Object.freeze([
  ...
  },
  {
    ...
    weight: 1.2,
    act: 'X',
    title: 'What is happening off the ranch',
    kicker: 'World',
    line: 'Earthquakes with a range and bearing from your gate, the fire detections, the agency cameras on the road out, and the headlines — each one labelled with what it actually needs, because only one of the four works with no setup at all.',
    tint: [0.20, 0.38, 0.52],
    energy: 0.44,
    shows: ['earthquakes', 'shaking-here', 'fire-points', 'traffic-cams', 'cam-discovery', 'regional-news', 'news-as-warning'],
  },
  {
    id: 'ledger',
    side: 0.76,
    ...
    kicker: 'Ledger',
    line: `${COUNT.UNSOUND} capabilities on this platform's own ledger do not follow from any measurement, with any hardware, at any price. They are listed here by name because a feature quietly missing reads as a feature that works — until the night it matters.`,
    tint: [0.40, 0.16, 0.22],
    energy: 0.35,
    shows: ['intent', 'threat-score', 'concealed-object', 'load-estimate', 'gait-id', 'through-wall-vitals', 'magnetic-firearm', 'auto-turret', 'nutrient-id', 'drone-id', 'thermal-from-visible', 'shaking-here', 'news-as-warning', 'cam-discovery'],
  },
  {
    id: 'launch',
    side: 0.5,

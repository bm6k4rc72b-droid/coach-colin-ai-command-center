 ...
 */
export const BANDS = [
  { id: 'established', min: 0.8, label: 'Well established', accent: '#3ef0b4', gloss: 'Replicated in randomised human trials.' },
  { id: 'supported', min: 0.6, label: 'Human-supported', accent: '#5ff0ff', gloss: 'Real human data, with gaps worth naming.' },
  { id: 'emerging', min: 0.4, label: 'Emerging', accent: '#a78bff', gloss: 'Early human or strong animal signal. Unsettled.' },
  { id: 'preclinical', min: 0.22, label: 'Preclinical only', accent: '#ffb347', gloss: 'Animal or cell work. Human translation unproven.' },
  { id: 'speculative', min: 0.1, label: 'Speculative', accent: '#ff8a5c', gloss: 'Mechanism or fragmentary data. Do not rely on it.' },
  { id: 'unsupported', min: 0, label: 'Unsupported', accent: '#ff4d8f', gloss: 'No usable evidence behind this claim.' },
];
